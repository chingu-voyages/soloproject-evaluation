...
| Condition | Feedback |
|-----------|----------|
| Passed | Hi @  Congratulations on your hard work and dedication. Your Solo Project has been accepted for Voyage 56, which starts on July 7, 2025. Watch the <#1026584387569078373> channel for more information. <br/><br/> ```**_If you haven't yet signed up for this Voyage please complete this form so you don't miss out _** ``` —> https://forms.gle/DajSfXQCX4qbMAu8A <br/><br/>I’m looking forward to seeing what you and your team will be creating in your Voyage! <br/><br/>https://c.tenor.com/bDxOr4tSm7kAAAAC/spongebob-high-five.gif <br/><br/>Here is some more specific feedback which I hope will be helpful: </br> |
