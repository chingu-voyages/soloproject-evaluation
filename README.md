...
| Condition | Feedback |
|-----------|----------|
| Passed | Hi @  Congratulations on your hard work and dedication. Your Solo Project has been accepted for Voyage 59, which starts on January 12, 2026. Watch the <#1026584387569078373> channel for more information. <br/><br/> ```**_If you haven't yet signed up for this Voyage please complete this form so you don't miss out _** ``` —> <https://forms.gle/DajSfXQCX4qbMAu8A> <br/><br/>I’m looking forward to seeing what you and your team will be creating in your Voyage! <br/><br/><https://c.tenor.com/bDxOr4tSm7kAAAAC/spongebob-high-five.gif> <br/><br/>Here is some more specific feedback which I hope will be helpful: </br> |
| Requested changes | Hi @  Your app shows that you’ve invested a considerable amount of thought and effort in its design & implementation. <br/><br/>Please make the following change and then open a ticket in <#1193342042080817323> (please do not submit a new solo project) when you are ready for me to look at it again. ``` **_This is the only change you are required to make._** ``` <br/><br/> ```__**Requested changes**__``` <br/> 1. ... <br/><br/>```**__Here’s additional feedback that I hope will be helpful__**```. |
...
| Requested changes - no application form (the app will say no discord Id found) |	Hi @ we couldn’t find a Chingu application form linked to your Discord account — this might be because you used a different email. Please open a ticket in #🎟open-support-ticket (rather than replying to this DM) and share your other email with us so we can update your records. <br/><br/> If you haven’t filled out an application form yet, please visit chingu.io, click “Apply for free”, and let us know once you’ve submitted it. We’ll then get started reviewing your solo project! |
---
...
| Multiple unrelated project in the same repo | High | ```*  While it’s great to see multiple projects in this repository, combining them in a single repo is generally NOT recommended, especially when they are not a part of a bigger project. Each project should ideally have its own repository with dedicated version control, documentation, and issue tracking. This approach makes your work easier to maintain, improves collaboration, and provides clearer version history. I recommend separating the projects into individual repos for better organization and scalability.```|
---
...
| Doesn’t follow DRY principle | High | ```* * Consider consolidating duplicate code and repeated logic to follow the DRY (Don't Repeat Yourself) principle. Right now, similar code blocks appear multiple times, e.g. --- , which can lead to inconsistencies and make updates more time-consuming. Centralizing shared functionality is a reliable way to reduce maintenance overhead and prevent bugs caused by missed updates. ``` |
